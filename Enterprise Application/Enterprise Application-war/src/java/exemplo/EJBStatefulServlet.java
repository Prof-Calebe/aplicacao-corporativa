 ...
 */
@WebServlet(name = "EJBStatefulServlet", urlPatterns = {"/EJBStatefulServlet"})
public class EJBStatefulServlet extends HttpServlet {

    @EJB
    private EJBStatefulExemploInterface ejb;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>EJBStatefulServlet</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            if (errorMessage != null) {
                ...
                out.println("</font>");
                out.println("<a href=\"EJBStateful.jsp\">Voltar</a><br/>");
            } else {
                out.println("<h1>Resultado da execução do EJBStateful</h1>");
                out.println("<p>" + ejb.get() + "</p><br/>");
